...
const Footer = () => {
  return (
    <footer className="mt-16 border-t border-[#1f2937] bg-[#0b1220] text-slate-300">
      <div className="mx-auto max-w-7xl px-4 py-14">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-4 text-md leading-7 text-slate-400">
          ...
          <div>
            ...
            <p className="text-md leading-7 text-slate-400">
              ...
              <div className="flex flex-col gap-3">
                {socialLinks.map((link) => (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="flex items-center gap-2 rounded-lg border border-white/10 px-3 py-2 text-sm text-slate-200 transition hover:border-[#10b981] hover:bg-[#10b981]/10 hover:text-[#10b981]"
                  >
                    {link.icon}
                    <span>{link.name}</span>
                  </a>
        ...
        <div className="mt-12 border-t border-[#1f2937] pt-6 text-center text-xs text-slate-500">
