  ...
  return (
    <section className="relative overflow-hidden py-10 md:py-16">
      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1fr_1fr]">
        ...
        {/* LEFT SECTION */}
        <div className="animate__animated animate__fadeInLeft rounded-3xl border border-emerald-600/10 bg-slate-950/50 p-8 shadow-xl backdrop-blur transition duration-300 hover:-translate-y-1 hover:border-emerald-400/20 hover:shadow-[0_25px_70px_rgba(16,185,129,0.10)]">
          ...
          <div className="mt-8 grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-5 backdrop-blur-sm transition duration-300 hover:-translate-y-2 hover:border-emerald-400/35 hover:bg-white/10 hover:shadow-[0_24px_70px_rgba(16,185,129,0.14)]">
        ...
        <Card className="animate__animated animate__fadeInUp mx-auto w-full max-w-[520px] rounded-3xl border border-white/10 bg-slate-950/90 shadow-2xl backdrop-blur transition duration-300 hover:-translate-y-2 hover:border-emerald-400/30 hover:shadow-[0_30px_90px_rgba(16,185,129,0.12)]">
          ...
          <Form className="flex flex-col gap-4 px-8 py-8" onSubmit={onSubmit}>
            ...
            <TextField isRequired name="image">
              ...
              <Input className={inputStyles} placeholder="https://image-url.com" />
              <FieldError />
            </TextField>
            ...
            <div className="flex flex-col gap-2.5 sm:flex-row">
              ...
              <Button
                type="reset"
                variant="bordered"
                className="h-11 flex-1 rounded-xl border-white/20 px-4 text-sm text-white transition duration-300 hover:-translate-y-0.5 hover:bg-white/10 hover:border-white/30"
              >
                Reset
              </Button>
